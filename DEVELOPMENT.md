...
(venv) $ runtime_fdr_management_tools --help
...
alias rfdr='runtime_fdr_management_tools'
alias rfdrc='runtime_fdr_management_tools commit'
alias rfdrr='runtime_fdr_management_tools release'
```
...
All commands are accessed through the unified `runtime_fdr_management_tools` command:

```bash
runtime_fdr_management_tools <command> [options]
```
...
# Get detailed help
runtime_fdr_management_tools --list

# Show usage examples
runtime_fdr_management_tools --examples

# Show help for all commands at once
runtime_fdr_management_tools --help-all

# Run a specific command
runtime_fdr_management_tools smart_commit_fast
runtime_fdr_management_tools validate_changelogs --help

# Use aliases
runtime_fdr_management_tools commit  # Alias for smart_commit_fast
runtime_fdr_management_tools c       # Short alias
```
...
# After reinstalling
pip install -e .
runtime_fdr_management_tools my_new_command --help
```
...
runtime_fdr_management_tools --list > COMMANDS.md
...
#### 1. "command not found: runtime_fdr_management_tools"
...
# Check installation
which runtime_fdr_management_tools
```
...
# Run setup
runtime_fdr_management_tools setup_ai_tools
```

### Development Tips

1. **Always use virtual environment** - It's not optional on modern systems
2. **Test commands both ways** - Direct Python and through `runtime_fdr_management_tools`
...
4. Test thoroughly
5. Commit with meaningful messages (use `runtime_fdr_management_tools commit`!)
